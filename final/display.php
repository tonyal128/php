...
?>
        ...
        <?php echo "<td><a href='update.php?sku=" . $result['sku'] . "'>Update</a></td>"; ?>
        <?php echo "<td><a href='delete.php?sku=" . $result['sku'] . "'>Delete</a></td>"; ?>
            </tr>
        </tbody>
...
<?php
    ...
    if(isset($SESSION['deletedSku'])){
		echo "<h1> Deleted SKU". $SESSION['deletedSku'] ."</h1>";
	}
?>
</table>
</div>	
